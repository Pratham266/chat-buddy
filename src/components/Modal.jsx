...
const Modal = ({
  ...
  return (
    <div
      id="modelConfirm"
      className={`fixed z-50 inset-0 bg-transparent backdrop-blur-sm overflow-y-auto h-full w-full px-4 bg-[#2d143e] ${extraClass}`}
      style={{ display: "block" }}
    >
      <div
        className={`relative mx-auto shadow-xl rounded-md bg-white max-w-md  bg-[#2d143e] ${bsClass}`}
      >
        {showHeader && (
